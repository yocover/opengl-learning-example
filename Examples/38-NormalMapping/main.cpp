...
int main()
{
	...
	// 使用转换到切线空间的TBN法线贴图
	Shader cubeShader("shader/tangent_normal_mapping_vert.glsl", "shader/tangent_normal_mapping_frag.glsl");
	...
	unsigned int diffauseMap = loadTexture("../../assert/texture/brickwall.jpg");
	unsigned int normalMap = loadTexture("../../assert/texture/brickwall_normal.jpg");
