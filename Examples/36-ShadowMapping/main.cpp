...
int main()
{
	...
	Shader cubeShader("cube_vert.glsl", "cube_frag.glsl");
	Shader planeShader("plane_vert.glsl", "plane_frag.glsl");

	Shader simpleDepthShader("shadow_mapping_depth_vert.glsl","shadow_mapping_depth_frag.glsl");
	Shader debugDepthQuad("debug_quad_vert.glsl", "debug_quad_frag.glsl");
	Shader shader("shadow_mapping_vert.glsl", "shadow_mapping_frag.glsl");
	...
	unsigned int planeTexture = loadTexture("../../assert/texture/hardwood2_diffuse.jpg");
	planeShader.use();
